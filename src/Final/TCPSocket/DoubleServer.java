    ...
    private static class ServiceThread extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                while ((heightStr = is.readLine()) != null && (weightStr = is.readLine()) != null) {
                    ...
                    try {
                        ...
                        os.write("Your BMI is: " + bmi);
                        os.newLine();
                        os.flush();
                    } catch (NumberFormatException e) {
                        os.write("Invalid input. Please enter valid numbers for height and weight.");
                        os.newLine();
                        os.flush();
                    }
                }
