    ...
    private static class ServiceThread extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                String clientDob;
                while ((clientDob = is.readLine()) != null) {
                    if (clientDob.equalsIgnoreCase("Quit")) {
                        System.out.println("Client disconnected.");
                        break;
                    }
                    BigInteger yob = new BigInteger(clientDob);
                    BigInteger cube = yob.pow(4);

                    os.write("The cube of your YOB is: " + cube);
                    os.newLine();
                    os.flush();
                }
            } catch (IOException e) {
